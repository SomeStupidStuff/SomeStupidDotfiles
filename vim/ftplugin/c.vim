...
iabbrev <buffer><expr> struct TabSnippet("struct", "typedef struct  {\<CR><C-u>};<C-o>k<C-o>$<C-o>h")
iabbrev <buffer><expr> enum TabSnippet("enum", "typedef enum  {\<CR><C-u>};<C-o>k<C-o>$<C-o>h")
