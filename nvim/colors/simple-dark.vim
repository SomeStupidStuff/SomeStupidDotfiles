...
" UI
hi LineNr       guifg=#555555   guibg=#000000   ctermfg=241    ctermbg=bg        gui=none      cterm=none
hi CursorLineNr guifg=#afafaf   guibg=#444444   ctermfg=246    ctermbg=bg        gui=none      cterm=none
...
hi EndOfBuffer  guifg=bg        guibg=bg        ctermfg=bg     ctermbg=bg        gui=none      cterm=none
